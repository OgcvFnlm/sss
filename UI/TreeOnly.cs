...
//            Model.TreeData TreeData = new Model.TreeData(); 
//            BLL.FillTreeData.FillData(TreeData,this.Name, ParentRoot);
//            foreach (var item in TreeData["1A"])
//            {
//                Nodes.Add(item[0].ToString(), item[1].ToString(), 0, 1);
//            }
//            //if (TreeData.Count > 0)
//            //{
//            //    string[] arr;
